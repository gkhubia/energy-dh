...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-10 animate-ping"
            style={{ animationDelay: '0.4s' }} />

      {/* Button */}
      <div
        className="relative w-14 h-14 rounded-full flex items-center justify-center
                   shadow-xl shadow-black/30 transition-transform duration-300
      ...
      <span
        className="absolute right-16 top-1/2 -translate-y-1/2 whitespace-nowrap
                   bg-navy-deep/95 border border-white/10 text-cream text-xs font-medium
